...
private:
   ...
   ******************************************/
    Node* mergeWithQueueHelper(Node* pt1, Node* pt2); //Helper function for mergeWithQueue
    void printPatientQueueHelper(Node* aNode) const; //Helper function for printPatientQueue
    void clearHelper(Node* aNode); //Helper function for clear
    void dumpHelper(Node* aNode) const; //Helper function for dump
    void copyHelper(Node* aNode); //Helper function for the copy constructor and assignment operator
};
