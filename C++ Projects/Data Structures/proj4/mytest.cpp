...
int main() {
    ...
    // operator!
    cout << "\nCreate copy of hash table (via copy constructor), remove two 'stratos' orders, "
            "dump both tables...\n";
    ...
    cout << "\nCreate copy of hash table (via assignment operator), remove two 'challenger' orders, "
            "dump both tables...\n";
    HashTable<Car> ht3 = ht;

    ht3.getNext("challenger", d);
    ht3.getNext("challenger", d);
    ...
    cout << "Attempt to remove a challenger order from ht3" << endl;
    if (!ht3.getNext("challenger", d))
    {
        cout << "Failed" << endl;
    }
